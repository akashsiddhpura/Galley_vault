                                      ...
                                      SizedBox(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(color: AppColor.primaryClr, fontSize: 11, height: 1, fontWeight: FontWeight.w600),
                                          ),
                                        ),
                                      ),
                                      Container(
                                        ...
                                        child: Text(
                                          ...
                                          maxLines: 2,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(color: AppColor.greyText, fontSize: 9, fontWeight: FontWeight.w400),
                                        ),
                                      ),
                                    ],
                                  ),
