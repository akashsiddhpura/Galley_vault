...
import 'package:gallery_vault/view/screen/MainPage/Explore/private_safe/security_screen.dart';
import 'package:gallery_vault/view/utils/navigation_utils/navigation.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'confirmpin2.dart';
...
class _Private_SafeState extends State<Private_Safe> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        body:privateSafePin==null ? const SecurityScreen():const ConfirmPin2() ,
      );
